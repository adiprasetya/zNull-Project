...
if gg.getTargetPackage() == "com.tencent.iglite"
or 
gg.getTargetPackage() == "com.rhmsoft.edit.pro"
then
    gg.clearResults()
  else
...
MENU = gg.choice({
  ...
  if MENU == 1 then bcwh() fixsc() end
  if MENU == 2 then fs() end
  if MENU == 3 then fp() end
...
function LobbyAlert()
  gg.setVisible(false)
  LA2 = gg.alert("\n☣ ＬＯＢＢＹ ☣","☣ YES ☣","☣ NO ☣")
if LA2 == 1 then bypass() bcwh() fixsc() mb() aim() less() small() as() end
end
